...
$sql = "SELECT salarydetails.SalaryID, salarydetails.eID, employees.Fname, salarydetails.CurrentSalary FROM `salarydetails` INNER JOIN employees WHERE salarydetails.SalaryID = employees.ID";
...
<html>
<head>
	<title>Salary Status |  Admin Panel | ABC Corporation</title>
		...
		<table>
			...
			<?php
				while ($employee = mysqli_fetch_assoc($result)) {
					echo "<tr>";
					echo "<td>".$employee['SalaryID']."</td>";
					echo "<td>".$employee['eID']."</td>";
                    echo "<td>".$employee['Fname']."</td>";
                    echo "<td>".$employee['CurrentSalary']."</td>";
