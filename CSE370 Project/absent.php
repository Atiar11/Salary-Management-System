...
$sql = "SELECT employees.ID, employees.Fname, absence.TotalDaysAbsent FROM employees INNER JOIN absence WHERE absence.eID = employees.ID";
	...
	<div class="divider"></div>
		...
		<table>
			<tr>
				...
				<th align = "center">Total Absence(Days)</th>
			...
			<?php
				while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['TotalDaysAbsent']."</td>";
